...
def marksheet():
       ...
       def Add():
              if (len(roll.get()) != 0):
                     Marksheet_Backend.insert(name.get(),roll.get(),fname.get(),mname.get(),DOB.get(),gender.get(),scl.get(),email.get(),m1.get(),m2.get(),m3.get(),m4.get(),m5.get(),gt.get(),per.get(),cgpa.get(),grade.get(),div.get(),result.get())

       def Update():
              if (len(roll.get()) != 0):
                     Marksheet_Backend.update(name.get(),roll.get(),fname.get(),mname.get(),DOB.get(),gender.get(),scl.get(),email.get(),m1.get(),m2.get(),m3.get(),m4.get(),m5.get(),gt.get(),per.get(),cgpa.get(),grade.get(),div.get(),result.get())
       ...
       Frame_1 = LabelFrame(root, width = 1200, height = 400, font = ('Walter Turncoat', 20), bg = 'light blue', text = 'Student Details', relief = 'ridge')
       Frame_1.grid(row = 1, column = 0, pady = 20, padx = 20)


       #=================================================Labels and Entries for Frame_1===============================================
       Label_Name = Label(Frame_1, text = 'Name', font = ('Sniglet', 17), bg = 'light blue')
       Label_Name.grid(row = 0, column = 0, padx = 80)
       Entry_Name = Entry(Frame_1, font = ('Sniglet', 17), width = 25, textvariable = name)
       Entry_Name.grid(row = 0, column = 1, padx = 5, pady = 5)

       Label_Roll_no = Label(Frame_1, text = 'Enrollment Number', font = ('Sniglet', 17), bg = 'light blue')
       Label_Roll_no.grid(row = 0, column = 3, padx = 80)
       Entry_Roll_no = Entry(Frame_1, font = ('Sniglet', 17), width = 25, textvariable = roll)
       Entry_Roll_no.grid(row = 0, column = 4, padx = 40)

       Label_Father_Name = Label(Frame_1, text = 'Fathers Name', font = ('Sniglet', 17), bg = 'light blue')
       Label_Father_Name.grid(row = 1, column = 0, padx = 80)
       Entry_Father_Name = Entry(Frame_1, font = ('Sniglet', 17), width = 25, textvariable = fname)
       Entry_Father_Name.grid(row = 1, column = 1, padx = 5, pady = 10)

       Label_Mother_Name = Label(Frame_1, text = 'Mothers Name', font = ('Sniglet', 17), bg = 'light blue')
       Label_Mother_Name.grid(row = 1, column = 3, padx = 80)
       Entry_Mother_Name = Entry(Frame_1, font = ('Sniglet', 17), width = 25, textvariable = mname)
       Entry_Mother_Name.grid(row = 1, column = 4, padx = 5)

       Label_DOB = Label(Frame_1, text = 'Date of Birth', font = ('Sniglet', 17), bg = 'light blue')
       ...
       Label_Gender = Label(Frame_1, text = 'Gender', font = ('Sniglet', 17), bg = 'light blue')
       ...
       Label_School = Label(Frame_1, text = 'School Name', font = ('Sniglet', 17), bg = 'light blue')
       Label_School.grid(row = 3, column = 0, padx = 80)
       Entry_School = Entry(Frame_1, font = ('Sniglet', 17), width = 25, textvariable = scl)
       Entry_School.grid(row = 3, column = 1, padx = 5, pady = 5)

       Label_Email = Label(Frame_1, text = 'School Email ID', font = ('Sniglet', 17), bg = 'light blue')
       ...
       #========================================================Frame_2==================================================================       
       Frame_2 = LabelFrame(root, width = 1200, height = 400, font = ('Walter Turncoat',20), bg = 'light blue', bd = 10 \
                            , text = 'Grades Obtained', relief = 'ridge')
       ...
       Label_Subject = Label(Frame_2, text = 'SUBJECT', font = ('Walter Turncoat',17), bg = 'light blue')
       Label_Subject.grid(row = 3, column = 0, padx = 50, pady = 10)

       Label_obt_Marks = Label(Frame_2, text = 'MARKS OBTAINED', font = ('Walter Turncoat',17), bg = 'light blue')
       Label_obt_Marks.grid(row = 3, column = 1, padx = 20)

       Label_Subject = Label(Frame_2, text = 'PASSING MARKS', font = ('Walter Turncoat',17), bg = 'light blue')
       Label_Subject.grid(row = 3, column = 2, padx = 20)

       Label_obt_Marks = Label(Frame_2, text = 'TOTAL MARKS', font = ('Walter Turncoat',17), bg = 'light blue')
       Label_obt_Marks.grid(row = 3, column = 3, padx = 20)

       Label_1 = Label(Frame_2, text = 'MATHEMATICS', font = ('Sniglet',15), bg = 'light blue')
       Label_1.grid(row = 4, column = 0)
       Label_2 = Label(Frame_2, text = 'PHYSICS', font = ('Sniglet',15), bg = 'light blue')
       Label_2.grid(row = 5, column = 0)
       Label_3 = Label(Frame_2, text = 'CHEMISTRY', font = ('Sniglet',15), bg = 'light blue')
       Label_3.grid(row = 6, column = 0)
       Label_4 = Label(Frame_2, text = 'HINDI', font = ('Sniglet',15), bg = 'light blue')
       Label_4.grid(row = 7, column = 0)
       Label_5 = Label(Frame_2, text = 'ENGLISH', font = ('Sniglet',15), bg = 'light blue')
       Label_5.grid(row = 8, column = 0)
       Label_6 = Label(Frame_2, text = 'GRAND TOTAL', font = ('Walter Turncoat',17), bg = 'light blue')
       Label_6.grid(row = 9, column = 0)
       Label_7 = Label(Frame_2, text = 'PERCENTAGE', font = ('Walter Turncoat',17), bg = 'light blue')
       Label_7.grid(row = 10, column = 0)
       Label_8 = Label(Frame_2, text = 'CGPA', font = ('Walter Turncoat',17), bg = 'light blue')
       Label_8.grid(row = 10, column = 2)
       Label_9 = Label(Frame_2, text = 'GRADE', font = ('Walter Turncoat',17), bg = 'light blue')
       Label_9.grid(row = 10, column = 4)
       Label_10 = Label(Frame_2, text = 'DIVISION', font = ('Walter Turncoat',17), bg = 'light blue')
       Label_10.grid(row = 11, column = 0)
       Label_10 = Label(Frame_2, text = 'RESULT', font = ('Walter Turncoat',17), bg = 'light blue')
       ...
       Btn_Update = Button(Frame_2, text = 'UPDATE', font = ('Sniglet',15), width = 10, command = Update)
...
def search_result_marksheet(row):
       ...
       Frame_1 = LabelFrame(root, width = 1200, height = 400, font = ('arial',20,'bold'), bg = 'light blue', bd = 10, \
       ...
       Label_Roll_no = Label(Frame_1, text = 'Roll Number', font = ('Sniglet', 17), bg = 'light blue')
       Label_Roll_no.grid(row = 0, column = 3, padx = 80)
       Entry_Roll_no = Entry(Frame_1, font = ('Sniglet', 17), width = 25, textvariable = roll)
       Entry_Roll_no.grid(row = 0, column = 4, padx = 40)

       Label_Father_Name = Label(Frame_1, text = 'Father Name', font = ('Sniglet', 17), bg = 'light blue')
       Label_Father_Name.grid(row = 1, column = 0, padx = 80)
       Entry_Father_Name = Entry(Frame_1, font = ('Sniglet', 17), width = 25, textvariable = fname)
       Entry_Father_Name.grid(row = 1, column = 1, padx = 5, pady = 10)

       Label_Mother_Name = Label(Frame_1, text = 'Mother Name', font = ('Sniglet', 17), bg = 'light blue')
       Label_Mother_Name.grid(row = 1, column = 3, padx = 80)
       Entry_Mother_Name = Entry(Frame_1, font = ('Sniglet', 17), width = 25, textvariable = mname)
       Entry_Mother_Name.grid(row = 1, column = 4, padx = 5)
       ...
       Label_Gender = Label(Frame_1, text = 'Gender', font = ('Sniglet', 17), bg = 'light blue')
       Label_Gender.grid(row = 2, column = 3, padx = 80)
       Entry_Gender = Entry(Frame_1, font = ('Sniglet', 17), width = 25, textvariable = gender)
       Entry_Gender.grid(row = 2, column = 4, padx = 5, pady = 5)
       ...
       Label_Email = Label(Frame_1, text = 'Email ID', font = ('Sniglet', 17), bg = 'light blue')
       Label_Email.grid(row = 3, column = 3, padx = 80)
       Entry_Email = Entry(Frame_1, font = ('Sniglet', 17), width = 25, textvariable = email)
       Entry_Email.grid(row = 3, column = 4, padx = 5, pady = 5)
       ...
       #========================================================Frame_2==================================================================       
       Frame_2 = LabelFrame(root, width = 1200, height = 400, font = ('Walter Turncoat',20), bg = 'light blue', bd = 10, text = 'Grades Point Obtained', relief = 'ridge')
       Frame_2.grid(row = 3, column = 0)
       ...
       Label_4 = Label(Frame_2, text = 'HINDI', font = ('Sniglet',15), bg = 'light blue')
       Label_4.grid(row = 7, column = 0)
       Label_5 = Label(Frame_2, text = 'ENGLISH', font = ('arial',14), bg = 'light blue')
       Label_5.grid(row = 8, column = 0)
       Label_6 = Label(Frame_2, text = 'GRAND TOTAL', font = ('Sniglet',15), bg = 'light blue')
       Label_6.grid(row = 9, column = 0)
       Label_7 = Label(Frame_2, text = 'PERCENTAGE', font = ('Sniglet',15), bg = 'light blue')
       Label_7.grid(row = 10, column = 0)
       Label_8 = Label(Frame_2, text = 'CGPA', font = ('Sniglet',15), bg = 'light blue')
       Label_8.grid(row = 10, column = 2)
       Label_9 = Label(Frame_2, text = 'GRADE', font = ('Sniglet',15), bg = 'light blue')
       Label_9.grid(row = 10, column = 4)
       Label_10 = Label(Frame_2, text = 'DIVISION', font = ('Sniglet',15), bg = 'light blue')
       Label_10.grid(row = 11, column = 0)
       Label_10 = Label(Frame_2, text = 'RESULT', font = ('Sniglet',15), bg = 'light blue')
       Label_10.grid(row = 11, column = 2)
       ...
       Entry__5 = Entry(Frame_2, font = ('Sniglet',15), width = 5, textvariable = m5)
       Entry__5.grid(row = 8, column = 1)
       Entry__6 = Entry(Frame_2, font = ('Sniglet',15), width = 5, textvariable = gt)
       Entry__6.grid(row = 9, column = 1, pady = 8)
       Entry__7 = Entry(Frame_2, font = ('Sniglet',15), width = 5, textvariable = per)
       Entry__7.grid(row = 10, column = 1, pady = 8)
       Entry__8 = Entry(Frame_2, font = ('Sniglet',15), width = 5, textvariable = cgpa)
       Entry__8.grid(row = 10, column = 3, pady = 8)
       Entry__9 = Entry(Frame_2, font = ('Sniglet',15), width = 5, textvariable = grade)
       Entry__9.grid(row = 10, column = 5, padx = 20, pady = 8)
       Entry__10 = Entry(Frame_2, font = ('Sniglet',15), width = 8, textvariable = div)
       Entry__10.grid(row = 11, column = 1, padx = 20, pady = 8)
       Entry__11 = Entry(Frame_2, font = ('Sniglet',15), width = 7, textvariable = result)
       Entry__11.grid(row = 11, column = 3, padx = 20, pady = 8)
       
       Entry_1_2 = Entry(Frame_2, textvariable = var_1, font = ('Sniglet',15), width = 5)
       Entry_1_2.grid(row = 4, column = 2, pady = 5)
       Entry_1_3 = Entry(Frame_2, textvariable = var_2, font = ('Sniglet',15), width = 5)
       Entry_1_3.grid(row = 4, column = 3)
       Entry_2_2 = Entry(Frame_2, textvariable = var_1, font = ('Sniglet',15), width = 5)
       Entry_2_2.grid(row = 5, column = 2, pady = 5)
       Entry_2_3 = Entry(Frame_2, textvariable = var_2, font = ('Sniglet',15), width = 5)
       Entry_2_3.grid(row = 5, column = 3)
       Entry_3_2 = Entry(Frame_2, textvariable = var_1, font = ('Sniglet',15), width = 5)
       Entry_3_2.grid(row = 6, column = 2, pady = 5)
       Entry_3_3 = Entry(Frame_2, textvariable = var_2, font = ('Sniglet',15), width = 5)
       Entry_3_3.grid(row = 6, column = 3)
       Entry_4_2 = Entry(Frame_2, textvariable = var_1, font = ('Sniglet',15), width = 5)
       Entry_4_2.grid(row = 7, column = 2, pady = 5)
       Entry_4_3 = Entry(Frame_2, textvariable = var_2, font = ('Sniglet',15), width = 5)
       Entry_4_3.grid(row = 7, column = 3)
       Entry_5_2 = Entry(Frame_2, textvariable = var_1, font = ('Sniglet',15), width = 5)
       Entry_5_2.grid(row = 8, column = 2, pady = 5)
       Entry_5_3 = Entry(Frame_2, textvariable = var_2, font = ('Sniglet',15), width = 5)
       Entry_5_3.grid(row = 8, column = 3)
       Entry_6_3 = Entry(Frame_2, textvariable = var_3, font = ('Sniglet',15), width = 5)
       Entry_6_3.grid(row = 9, column = 3)
                
       #======================================================Buttons===========================================================
       
       Btn_Exit = Button(Frame_2, text = 'EXIT', font = ('Sniglet',15), width = 10, command = root.destroy)
       Btn_Exit.grid(row = 8, column = 4, padx = 50, pady = 6)
